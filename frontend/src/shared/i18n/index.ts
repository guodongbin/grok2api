  ...
  "zh-CN": {
    translation: {
      ...
      creativeConsole: {
        ...
        clearCurrent: "清空本轮会话",
        clearCurrentTitle: "清空本轮会话？",
        clearCurrentDescription: "当前会话将从历史记录中永久删除，且无法撤销。",
        clearLastMessageTitle: "删除最后一条消息？",
        clearLastMessageDescription: "这是会话中的最后一条消息，删除后整个会话将从历史记录中移除，且无法撤销。",
        history: "历史记录",
        noHistory: "暂无历史记录",
        regenerate: "重新生成",
        editMessage: "修改消息",
  ...
  en: {
    translation: {
      ...
      creativeConsole: {
        ...
        clearCurrentTitle: "Clear the current conversation?",
        clearCurrentDescription: "The current conversation will be permanently removed from history. This cannot be undone.",
        clearLastMessageTitle: "Delete the last message?",
        clearLastMessageDescription: "This is the last message in the conversation; deleting it removes the whole conversation from history. This cannot be undone.",
        history: "History",
...
Object.assign(resources.en.translation.settings.egress as unknown as Record<string, string>, {
  ...
  sourceSaved: "Proxy subscription saved", sourceDeleted: "Proxy subscription deleted", deleteSourceTitle: "Delete proxy subscription?", deleteSourceDescription: "This deletes the subscription source \"{{name}}\" and its sync configuration. This cannot be undone.", sourceSynced: "Proxy subscription synced: {{imported}} imported, {{skipped}} skipped",
